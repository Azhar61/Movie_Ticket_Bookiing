  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        @csrf
            <div class="mb-2">
                <input type="text" placeholder="Movie Title" class="form-control" name="" id="">
            </div>
            <div class="mb-2">
                <input type="date" placeholder="Show Date" class="form-control" name="" id="">
            </div>
            <div class="mb-2">
                <input type="time" placeholder="Trailer Link" class="form-control" name="" id="">
